...
ActiveRecord::Schema.define(version: 2021_02_04_060608) do
  ...
  create_table "bookmarks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["study_event_id"], name: "index_bookmarks_on_study_event_id"
    t.index ["user_id", "study_event_id"], name: "index_bookmarks_on_user_id_and_study_event_id", unique: true
  ...
  create_table "event_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "tag_id", null: false
    t.bigint "study_event_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["study_event_id"], name: "index_event_tags_on_study_event_id"
    t.index ["tag_id"], name: "index_event_tags_on_tag_id"
  end

  create_table "event_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "study_event_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "study_events", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.text "description", null: false
  ...
  create_table "tag_relationships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.index ["profile_id"], name: "index_tag_relationships_on_profile_id"
  ...
  add_foreign_key "bookmarks", "study_events"
  add_foreign_key "bookmarks", "users"
  add_foreign_key "entries", "rooms"
  add_foreign_key "entries", "users"
  add_foreign_key "event_tags", "study_events"
